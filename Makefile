# This Makefile is for the Apache2::WebApp::Plugin::Filters extension to perl.
#
...
#     AUTHOR => q[Marc S. Brooks (mbrooks@cpan.org)]
#     NAME => q[Apache2::WebApp::Plugin::Filters]
#     PREREQ_PM => { Apache2::WebApp=>q[0.01], Params::Validate=>q[0], HTML::StripScripts::Parser=>q[1.02], Apache::Test=>q[0] }
#     VERSION_FROM => q[lib/Apache2/WebApp/Plugin/Filters.pm]
#     clean => { FILES=>q[t/TEST] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Apache2::WebApp::Plugin::Filters
NAME_SYM = Apache2_WebApp_Plugin_Filters
VERSION = 0.03
...
MAKE = make
FULLEXT = Apache2/WebApp/Plugin/Filters
BASEEXT = Filters
PARENT_NAME = Apache2::WebApp::Plugin
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache2/WebApp/Plugin/Filters.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Apache2/WebApp/Plugin/Filters.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Apache2/WebApp/Plugin
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Apache2/WebApp/Plugin
...
TO_INST_PM = lib/Apache2/WebApp/Plugin/Filters.pm

PM_TO_BLIB = lib/Apache2/WebApp/Plugin/Filters.pm \
	blib/lib/Apache2/WebApp/Plugin/Filters.pm
...
DISTNAME = Apache2-WebApp-Plugin-Filters
DISTVNAME = Apache2-WebApp-Plugin-Filters-0.03
...
manifypods : pure_all  \
	lib/Apache2/WebApp/Plugin/Filters.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Apache2/WebApp/Plugin/Filters.pm $(INST_MAN3DIR)/Apache2::WebApp::Plugin::Filters.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Apache2-WebApp-Plugin-Filters' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.03' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Marc S. Brooks (mbrooks@cpan.org)' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Apache2::WebApp:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) '    Apache::Test:         0' >> META_new.yml
	$(NOECHO) $(ECHO) '    HTML::StripScripts::Parser:  1.02' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Marc S. Brooks (mbrooks@cpan.org)</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Apache2::WebApp" VERSION="0.01" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Apache::Test" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTML::StripScripts::Parser" VERSION="1.02" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Apache2/WebApp/Plugin/Filters.pm blib/lib/Apache2/WebApp/Plugin/Filters.pm 
